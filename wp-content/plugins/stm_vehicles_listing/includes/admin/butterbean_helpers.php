...
function stm_save_genuine_price( $post_id ) {
    ...
    if(isset($_POST['butterbean_stm_car_manager_setting_price']) || isset($_POST['butterbean_stm_car_manager_setting_sale_price'])) {
        $price = (isset($_POST['butterbean_stm_car_manager_setting_sale_price'])) ? $_POST['butterbean_stm_car_manager_setting_sale_price'] : $_POST['butterbean_stm_car_manager_setting_price'];
    }

    if(isset($_POST['stm_car_sale_price']) || isset($_POST['stm_car_price'])) {
        $price = (isset($_POST['stm_car_sale_price'])) ? $_POST['stm_car_sale_price'] : $_POST['stm_car_price'];
    }

    ...
    public static function priceForDateView() {
        ...
        <div class="rental-price-date-wrap">
            <ul class="rental-price-date-list">
                        ...
                        <li>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="date-pickup" value="<?php echo date('Y/m/d H:i', $val->starttime); ?>" name="date-pickup[]" <?php echo esc_attr($disabled);?> />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="date-drop" value="<?php echo date('Y/m/d H:i', $val->endtime); ?>" name="date-drop[]" <?php echo esc_attr($disabled);?> />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" value="<?php echo esc_attr($val->price); ?>" name="date-price[]" <?php echo esc_attr($disabled);?> />
                                    </td>
                                </tr>
                            </table>
                            <div class="btn-wrap">
                                <button class="remove-fields button-secondary" data-remove="<?php echo esc_attr($val->id); ?>" <?php echo esc_attr($disabled);?>>Remove</button>
                            </div>
                        </li>
                    <?php
                    endforeach;
                ...
                ?>
                <li>
                    <button class="repeat-fields button-primary button-large" <?php echo esc_attr($disabled);?>>Add</button>
                </li>
            </ul>

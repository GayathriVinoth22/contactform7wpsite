    ...
    public static function discountByDaysView() {
        ...
        <div class="discount-by-days-wrap">
            <ul class="discount-by-days-list">
                        ...
                        <li>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" value="<?php echo esc_attr($val['days']); ?>" name="days[]" <?php echo esc_attr($disabled);?>/>
                                    </td>
                                    <td>>=</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" value="<?php echo esc_attr($val['percent']); ?>" name="percent[]" <?php echo esc_attr($disabled);?>/>
                                    </td>
                                    <td>
                                        %
                                    </td>
                            ...
                            <div class="btn-wrap">
                                <button class="remove-days-fields button-secondary" <?php echo esc_attr($disabled);?>>Remove</button>
                            </div>
                        </li>
                    <?php
                        $i++;
                ...
                ?>
                <li>
                    <button class="repeat-days-fields button-primary button-large" <?php echo esc_attr($disabled);?>>Add</button>
                </li>
            </ul>
